...
def get_clusters():
    cluster_array, _ = make_classification(n_samples=30, n_features=2, n_informative=2, n_redundant=0, n_clusters_per_class=1, random_state=None)#50
...
def cluster_former():
    ...
    while(len(clus1)!=15): #or len(clus2)!=15):
        arranged_clusters=get_clusters()
        clus1=arranged_clusters[0]['Members']
        clus2=arranged_clusters[1]['Members']
